...
try {
    ...
    $mail->addAddress('eriipadron@gmail.com', 'Erika');     //Add a recipient
    ...
    $mail->Body    = 'Nombre: '.$_POST['inp_nombre'].'<br>Apellido: '.$_POST['inp_nro'].'<br>Mensaje: '.$_POST['inp_mensaje'].'<br>Email: '.$_POST['inp_email'];
